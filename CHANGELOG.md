...
- [SLSA](https://slsa.dev/) v1.0 attestations conforming to the level 3 of the
  build track are now generated for the official PackSquash binary artifacts.
  ...
  - The [`slsa-verifier`](https://github.com/slsa-framework/slsa-verifier) tool
    can be used to verify these attestations after downloading the attached
    provenance data.
  - The PackSquash Docker images include SLSA v0.2 attestations, generated by
    [Docker
    BuldKit](https://docs.docker.com/build/attestations/slsa-provenance/).
