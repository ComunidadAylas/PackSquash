...
struct OptimizationSettings {
	...
	maximum_size: u32,
	/// Some Minecraft verions use a PNG decoder implementation (namely, Java's ImageIO class)
	/// that interprets grayscale PNG files generated by PackSquash as if they were stored in
	/// linear gamma, miscorrecting them to sRGB before display. This results in washed-out
	/// colors. This setting makes sure that images that are not already grayscale do not get
	/// converted to grayscale. Also, sometimes a color palette may be more space-efficient
	/// than grayscale for some images.
	skip_grayscale_color_reduction: bool
}
...
impl Default for OptimizationSettings {
	fn default() -> Self {
		Self {
			...
			maximum_size: 4096,
			skip_grayscale_color_reduction: false
		}
	}
}
...
impl Decoder for OptimizerDecoder {
	...
	fn decode(&mut self, src: &mut BytesMut) -> Result<Option<Self::Item>, Self::Error> {
		...
		let oxipng_options = Options {
			...
			grayscale_reduction: !self.optimization_settings.skip_grayscale_color_reduction,
