...
about-screen-app-license-text =
    Este programa é software libre: podes redistribuilo e/ou modificalo baixo os termos da GNU Affero General Public License publicada pola Free Software Foundation, xa sexa a versión 3 da Licencia ou, a túa escolla, calquera versión posterior.
...
crash-screen-error-details-text =
    A interface de usuario encontrou un problema inesperado.
...
pack-selection-screen-caption-text =
    { -app-name } precisa saber qué paquete optimizar.
...
configuration-screen-custom-options-file-parse-error =
    Ocorreu un erro ao ler o ficheiro de opcións. É válido?
