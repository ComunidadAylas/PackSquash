...
about-screen-app-license-text = Este programa es software libre: puedes redistribuirlo y/o modificarlo bajo los términos de la GNU Affero General Public License publicada por la Free Software Foundation, ya sea la versión 3 de la Licencia o, a tu elección, cualquier versión posterior.
...
crash-screen-error-details-text = La interfaz de usuario ha encontrado un problema inesperado.
...
pack-selection-screen-caption-text = { -app-name } necesita saber qué paquete optimizar.
...
configuration-screen-custom-options-file-parse-error = Ha ocurrido un error al leer el fichero de opciones. ¿Es válido?
