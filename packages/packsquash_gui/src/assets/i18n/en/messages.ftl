...
configuration-screen-default-options-action-description = The recommended starting point for vanilla packs if you don't have specific needs. PackSquash will "just work" in most cases.
configuration-screen-custom-options-action = Define and use customized options
configuration-screen-custom-options-action-description = Choose this if you need to change how PackSquash operates, or if you want to use features like mod support and ZIP protection.
